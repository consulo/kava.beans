...
public class IndexedPropertyDescriptor extends PropertyDescriptor
{
    ...
    public IndexedPropertyDescriptor(String propertyName, Class<?> beanClass,
            ...
            String indexedSetterName) throws kava.beans.IntrospectionException
	{
            ...
            String indexedSetterName) throws kava.beans.IntrospectionException
	{
        ...
        if (!isCompatible()) {
            ...
            throw new kava.beans.IntrospectionException(Messages.getString("beans.57")); //$NON-NLS-1$
        }
    }
            ...
            throws kava.beans.IntrospectionException
	{
        ...
        try {
            ...
            throw new kava.beans.IntrospectionException(Messages.getString("beans.58")); //$NON-NLS-1$
        } catch (SecurityException exception) {
            // beans.59=Security violation accessing indexed read method
            throw new kava.beans.IntrospectionException(Messages.getString("beans.59")); //$NON-NLS-1$
        }
            ...
            throws kava.beans.IntrospectionException
	{
        ...
        if (indexGetter == null) {
            if (indexedSetter == null) {
                if (getPropertyType() != null) {
                    ...
                    throw new kava.beans.IntrospectionException(Messages
        ...
        if ((indexGetter.getParameterTypes().length != 1)
            ...
            throw new kava.beans.IntrospectionException(Messages.getString("beans.5B")); //$NON-NLS-1$
        }
        ...
        if (indexedReadType == Void.TYPE) {
            ...
            throw new kava.beans.IntrospectionException(Messages.getString("beans.5A")); //$NON-NLS-1$
        }
            ...
            throws kava.beans.IntrospectionException
	{
        ...
        try {
            ...
            throw new kava.beans.IntrospectionException(Messages.getString("beans.5C")); //$NON-NLS-1$
        } catch (NoSuchMethodException e) {
            // beans.5D=No such indexed write method
            throw new kava.beans.IntrospectionException(Messages.getString("beans.5D")); //$NON-NLS-1$
        }
    ...
    private void internalSetIndexedWriteMethod(Method indexSetter,
            boolean initialize) throws kava.beans.IntrospectionException
	{
        ...
        if (indexedSetterArgs.length != 2) {
            ...
            throw new kava.beans.IntrospectionException(Messages.getString("beans.5F")); //$NON-NLS-1$
        }
        if (indexedSetterArgs[0] != Integer.TYPE) {
            // beans.60=Indexed write method must take an int as its first argument
            throw new kava.beans.IntrospectionException(Messages.getString("beans.60")); //$NON-NLS-1$
        }
