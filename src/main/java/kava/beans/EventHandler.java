...
public class EventHandler implements InvocationHandler {
    ...
    private Object[] getArgs(Object[] arguments) throws Exception {
        if (eventPropertyName == null) {
            ...
            while (st.hasMoreTokens()) {
                ...
                kava.beans.PropertyDescriptor pd = findPropertyDescriptor(arg.getClass(),
                        propertyName);
                ...
                if (pd != null) {
                    ...
                    if (getter != null) {
                        ...
                        throw new kava.beans.IntrospectionException(Messages.getString(
    ...
    private Method getMethod(Object proxy, Method method, Object[] arguments,
        ...
        try {
            ...
            if (result == null) {
                kava.beans.PropertyDescriptor pd = findPropertyDescriptor(target
                        .getClass(), action);
        ...
        } catch (kava.beans.IntrospectionException ie) {
    ...
    private kava.beans.PropertyDescriptor findPropertyDescriptor(Class<?> theClass,
            String propertyName) throws IntrospectionException
	{
        kava.beans.PropertyDescriptor result = null;
        BeanInfo beanInfo = kava.beans.Introspector.getBeanInfo(theClass);
        kava.beans.PropertyDescriptor[] pds = beanInfo.getPropertyDescriptors();
