...
class ArrayPersistenceDelegate extends kava.beans.PersistenceDelegate
{

    private static kava.beans.PersistenceDelegate pd = null;
    ...
    @Override
    protected kava.beans.Expression instantiate(Object oldInstance, kava.beans.Encoder out) {
    ...
    protected void initialize(Class<?> type, Object oldInstance,
        ...
        for (int i = 0; i < length; ++i) {
            ...
            if (!deepEquals(oldValue, newValue)) {
                kava.beans.Statement s = new Statement(oldInstance, "set", //$NON-NLS-1$
