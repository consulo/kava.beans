...
public class XMLDecoder {
    ...
    private class SAXHandler extends DefaultHandler {
        ...
        private Object executeCommon(Elem elem) throws Exception {
            ...
            if (elem.fromField) {
                ...
                return (new kava.beans.Expression(f, "get", new Object[] { null }))
                        .getValue();
            }
            if (elem.fromOwner) {
                return owner;
            ...
            // execute
            kava.beans.Expression exp = new Expression(elem.target, method, args.toArray());
            return exp.getValue();
        }
    ...
    private kava.beans.ExceptionListener listener;
     ...
     */
    public XMLDecoder(InputStream inputStream, Object owner,
            kava.beans.ExceptionListener listener) {
        this(inputStream, owner, listener, null);
    }

    public XMLDecoder(InputStream inputStream, Object owner,
            kava.beans.ExceptionListener listener, ClassLoader cl) {
