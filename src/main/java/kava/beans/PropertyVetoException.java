...
public class PropertyVetoException extends Exception {
    ...
    private final kava.beans.PropertyChangeEvent evt;
     ...
     */
    public PropertyVetoException(String message, kava.beans.PropertyChangeEvent event) {
        super(message);
        this.evt = event;
    }
     ...
     * </p>
     * 
     * @return An instance of {@link kava.beans.PropertyChangeEvent}
     */
