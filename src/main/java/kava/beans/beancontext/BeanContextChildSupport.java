...
import kava.beans.VetoableChangeSupport;
...
public class BeanContextChildSupport implements kava.beans.beancontext.BeanContextChild, kava.beans.beancontext.BeanContextServicesListener, Serializable {
    ...
    protected transient kava.beans.beancontext.BeanContext beanContext;

    public kava.beans.beancontext.BeanContextChild beanContextChildPeer;
    ...
    private transient kava.beans.beancontext.BeanContext lastVetoedContext;
    ...
    public BeanContextChildSupport(kava.beans.beancontext.BeanContextChild bcc) {
    ...
    public synchronized kava.beans.beancontext.BeanContext getBeanContext() {
    ...
    public void serviceAvailable(BeanContextServiceAvailableEvent bcsae) {
        if (isDelegated()) {
            ((kava.beans.beancontext.BeanContextServicesListener) beanContextChildPeer)
    ...
    public synchronized void setBeanContext(kava.beans.beancontext.BeanContext bc)
            throws PropertyVetoException {
