 ...
 * 
 */
public class BeanContextServicesSupport extends BeanContextSupport implements kava.beans.beancontext.BeanContextServices, Serializable {

    private static class ServiceRecord {

        kava.beans.beancontext.BeanContextServiceProvider provider;

        kava.beans.beancontext.BeanContextChild child;

        Object requestor;

        Class serviceClass;

        kava.beans.beancontext.BeanContextServiceRevokedListener revokedListener;

        Object service;

        boolean isDelegate;

        ServiceRecord(kava.beans.beancontext.BeanContextServiceProvider provider,
                kava.beans.beancontext.BeanContextChild child, Object requestor, Class serviceClass,
                kava.beans.beancontext.BeanContextServiceRevokedListener revokedListener,
     ...
     * 
     */
    protected class BCSSProxyServiceProvider implements kava.beans.beancontext.BeanContextServiceProvider, kava.beans.beancontext.BeanContextServiceRevokedListener
	{

        private kava.beans.beancontext.BeanContextServices backBCS;

        BCSSProxyServiceProvider(kava.beans.beancontext.BeanContextServices backBCS) {
         ...
         */
        public Iterator getCurrentServiceSelectors(kava.beans.beancontext.BeanContextServices bcs,
                Class serviceClass) {
         ...
         * Throws <code>UnsupportedOperationException</code>.
         */
        public Object getService(kava.beans.beancontext.BeanContextServices bcs, Object requestor,
         ...
         */
        Object getService(kava.beans.beancontext.BeanContextServices bcs, Object requestor,
                Class serviceClass, Object serviceSelector,
                kava.beans.beancontext.BeanContextServiceRevokedListener listener)
         ...
         * Delegate to the wrapped <code>BeanContextServices</code>.
         */
        public void releaseService(kava.beans.beancontext.BeanContextServices bcs, Object requestor,
                Object service) {
         ...
         * Throws <code>UnsupportedOperationException</code>.
         */
        public void serviceRevoked(kava.beans.beancontext.BeanContextServiceRevokedEvent bcsre) {
            throw new UnsupportedOperationException();
        }

    }

    private class ServiceRevokedListenerDelegator implements kava.beans.beancontext.BeanContextServiceRevokedListener
	{

        private kava.beans.beancontext.BeanContextServiceRevokedListener backListener;

        public ServiceRevokedListenerDelegator(
                kava.beans.beancontext.BeanContextServiceRevokedListener backListener) {
            this.backListener = backListener;
        }

        public void serviceRevoked(kava.beans.beancontext.BeanContextServiceRevokedEvent event) {
            backListener.serviceRevoked(new kava.beans.beancontext.BeanContextServiceRevokedEvent(
    ...
    protected static class BCSSServiceProvider implements Serializable {
         ...
         */
        protected kava.beans.beancontext.BeanContextServiceProvider serviceProvider;

        BCSSServiceProvider(kava.beans.beancontext.BeanContextServiceProvider provider) {
         ...
         */
        protected kava.beans.beancontext.BeanContextServiceProvider getServiceProvider() {
     ...
     */
    public BeanContextServicesSupport(kava.beans.beancontext.BeanContextServices peer) {
        super(peer);
    }
     ...
     */
    public BeanContextServicesSupport(kava.beans.beancontext.BeanContextServices peer, Locale locale) {
        super(peer, locale);
    }
    ...
    public void addBeanContextServicesListener(
            kava.beans.beancontext.BeanContextServicesListener listener) {
        if (listener == null) {
     ...
     * </p>
     * 
     * @see kava.beans.beancontext.BeanContextServices#addService(java.lang.Class,
     *      kava.beans.beancontext.BeanContextServiceProvider)
     */
    ...
    protected boolean addService(Class serviceClass,
            kava.beans.beancontext.BeanContextServiceProvider provider, boolean fireEvent) {
        ...
        if (fireEvent) {
            ...
            notifyServiceAvailable(new kava.beans.beancontext.BeanContextServiceAvailableEvent(this,
                    serviceClass));
        }
        return true;
    }

    private void notifyServiceAvailable(kava.beans.beancontext.BeanContextServiceAvailableEvent event) {
        fireServiceAdded(event);
        Object childs[] = copyChildren();
        for (int i = 0; i < childs.length; i++) {
            if (childs[i] instanceof kava.beans.beancontext.BeanContextServices) {
                ((kava.beans.beancontext.BeanContextServices) childs[i]).serviceAvailable(event);
            }
        }
    }
    ...
    protected final void fireServiceAdded(Class serviceClass) {
        fireServiceAdded(new kava.beans.beancontext.BeanContextServiceAvailableEvent(this,
                serviceClass));
    }
     ...
     *            the event
     */
    protected final void fireServiceAdded(kava.beans.beancontext.BeanContextServiceAvailableEvent event) {
        Object listeners[];
        synchronized (bcsListeners) {
            listeners = bcsListeners.toArray();
        }
        for (int i = 0; i < listeners.length; i++) {
            kava.beans.beancontext.BeanContextServicesListener l = (kava.beans.beancontext.BeanContextServicesListener) listeners[i];
    ...
    protected final void fireServiceRevoked(Class serviceClass,
            boolean revokeNow) {
        fireServiceRevoked(new kava.beans.beancontext.BeanContextServiceRevokedEvent(this,
     ...
     *            the event
     */
    protected final void fireServiceRevoked(kava.beans.beancontext.BeanContextServiceRevokedEvent event) {
        Object listeners[];
        synchronized (bcsListeners) {
            listeners = bcsListeners.toArray();
        }
     ...
     *         <code>BeanContextServices</code>
     */
    public kava.beans.beancontext.BeanContextServices getBeanContextServicesPeer() {
        return (kava.beans.beancontext.BeanContextServices) beanContextChildPeer;
    }
     ...
     */
    protected static final kava.beans.beancontext.BeanContextServicesListener getChildBeanContextServicesListener(
            Object child) {
        if (child instanceof kava.beans.beancontext.BeanContextServicesListener) {
            return (kava.beans.beancontext.BeanContextServicesListener) child;
        }
        return null;
    }
     ...
     * @see kava.beans.beancontext.BeanContextServices#getCurrentServiceClasses()
     */
     ...
     * 
     * @see kava.beans.beancontext.BeanContextServices#getCurrentServiceSelectors(java.lang.Class)
     */
    public Iterator getCurrentServiceSelectors(Class serviceClass) {
        kava.beans.beancontext.BeanContextServiceProvider provider = getLocalServiceProvider(serviceClass);
        return provider == null ? null : new BCSIterator(provider
                .getCurrentServiceSelectors(getBeanContextServicesPeer(),
                        serviceClass));
    }

    private kava.beans.beancontext.BeanContextServiceProvider getLocalServiceProvider(
            Class serviceClass) {
        synchronized (services) {
     ...
     * @throws TooManyListenersException
     * @see kava.beans.beancontext.BeanContextServices#getService(kava.beans.beancontext.BeanContextChild,
     *      java.lang.Object, java.lang.Class, java.lang.Object,
     *      kava.beans.beancontext.BeanContextServiceRevokedListener)
     */
    public Object getService(kava.beans.beancontext.BeanContextChild child, Object requestor,
            Class serviceClass, Object serviceSelector,
        ...
        kava.beans.beancontext.BeanContextServiceProvider provider = null;
        Object service = null;
     ...
     * @see kava.beans.beancontext.BeanContextServices#hasService(java.lang.Class)
     */
    public boolean hasService(Class serviceClass) {
        ...
        if (!has && getBeanContext() instanceof kava.beans.beancontext.BeanContextServices) {
            has = ((kava.beans.beancontext.BeanContextServices) getBeanContext())
    ...
    public void initialize() {
        ...
        serializable = 0;
        proxy = null;
        bcsListeners = new ArrayList<kava.beans.beancontext.BeanContextServicesListener>();
    }
    ...
    protected void initializeBeanContextResources() {
        ...
        if (context instanceof kava.beans.beancontext.BeanContextServices) {
            proxy = new BCSSProxyServiceProvider((kava.beans.beancontext.BeanContextServices) context);
        } else {
            proxy = null;
        }
    }
     ...
     *             if <code>child</code> is not a child of this context
     */
    public void releaseService(kava.beans.beancontext.BeanContextChild child, Object requestor,
            Object service) {
            ...
            for (Iterator iter = bcssChild.serviceRecords.iterator(); iter
                ...
                if (rec.requestor == requestor && rec.service == service) {
                    ...
                    if (callRevokedListener && rec.revokedListener != null) {
                        rec.revokedListener
                                .serviceRevoked(new kava.beans.beancontext.BeanContextServiceRevokedEvent(
     ...
     * @see kava.beans.beancontext.BeanContextServices#revokeService(java.lang.Class,
     *      kava.beans.beancontext.BeanContextServiceProvider, boolean)
     */
    public void revokeService(Class serviceClass,
            kava.beans.beancontext.BeanContextServiceProvider serviceProvider,
     ...
     * 
     * @see kava.beans.beancontext.BeanContextServicesListener#serviceAvailable(kava.beans.beancontext.BeanContextServiceAvailableEvent)
     */
     ...
     * <code>BeanContextServices</code> of the event.
     * 
     * @see kava.beans.beancontext.BeanContextServiceRevokedListener#serviceRevoked(kava.beans.beancontext.BeanContextServiceRevokedEvent)
     */
