...
import static kava.beans.Introspector.decapitalize;
...
class StandardBeanInfo extends SimpleBeanInfo
{
    ...
    private kava.beans.BeanInfo explicitBeanInfo = null;

    private kava.beans.EventSetDescriptor[] events = null;

    private kava.beans.MethodDescriptor[] methods = null;

    private kava.beans.PropertyDescriptor[] properties = null;

    kava.beans.BeanInfo[] additionalBeanInfo = null;
    ...
    StandardBeanInfo(Class<?> beanClass, kava.beans.BeanInfo explicitBeanInfo, Class<?> stopClass)
    ...
    @Override
    public kava.beans.BeanInfo[] getAdditionalBeanInfo() {
        return null;
    }

    @Override
    public kava.beans.EventSetDescriptor[] getEventSetDescriptors() {
        return events;
    }

    @Override
    public kava.beans.MethodDescriptor[] getMethodDescriptors() {
        return methods;
    }

    @Override
    public kava.beans.PropertyDescriptor[] getPropertyDescriptors() {
        return properties;
    }

    @Override
    public kava.beans.BeanDescriptor getBeanDescriptor() {
        if (explicitBeanInfo != null) {
            kava.beans.BeanDescriptor beanDesc = explicitBeanInfo.getBeanDescriptor();
            if (beanDesc != null) {
                return beanDesc;
            }
        }
            ...
            throws kava.beans.IntrospectionException
	{
        if (force || !explicitProperties) {
            kava.beans.PropertyDescriptor[] superDescs = beanInfo.getPropertyDescriptors();
            if (superDescs != null) {
        ...
        if (force || !explicitMethods) {
            kava.beans.MethodDescriptor[] superMethods = beanInfo.getMethodDescriptors();
        ...
        if (force || !explicitEvents) {
            kava.beans.EventSetDescriptor[] superEvents = beanInfo
     ...
     */
    private kava.beans.PropertyDescriptor[] mergeProps(kava.beans.PropertyDescriptor[] superDescs,
            int superDefaultIndex) throws kava.beans.IntrospectionException
	{
        // FIXME:change to OO way as EventSetD and MethodD
        HashMap<String, kava.beans.PropertyDescriptor> subMap = internalAsMap(properties);
        ...
        for (int i = 0; i < superDescs.length; i++) {
            kava.beans.PropertyDescriptor superDesc = superDescs[i];
            ...
            Method subGet = ((kava.beans.PropertyDescriptor) value).getReadMethod();
            Method subSet = ((kava.beans.PropertyDescriptor) value).getWriteMethod();
            ...
            Class<?> subType = ((kava.beans.PropertyDescriptor) value).getPropertyType();
            Class<?> subIndexedType = null;

            if (value instanceof kava.beans.IndexedPropertyDescriptor) {
                subIndexedType = ((kava.beans.IndexedPropertyDescriptor) value)
                        .getIndexedPropertyType();
            }
            if (superDesc instanceof kava.beans.IndexedPropertyDescriptor) {
                superIndexedType = ((kava.beans.IndexedPropertyDescriptor) superDesc)
                        .getIndexedPropertyType();
            }

            // if superDesc is PropertyDescriptor
            if (superIndexedType == null) {
                kava.beans.PropertyDescriptor subDesc = (kava.beans.PropertyDescriptor) value;
                ...
                if (subIndexedType == null) {
                    ...
                    if (subType != null && superType != null
                        ...
                        if ((subGet == null || subSet == null)
                                && (superGet != null)) {
                            subDesc = new kava.beans.PropertyDescriptor(propertyName,
                                    superGet, superSet);
                            if (subGet != null) {
                                String subGetName = subGet.getName();
                                Method method = null;
                                kava.beans.MethodDescriptor[] introspectMethods = introspectMethods();
                                for (kava.beans.MethodDescriptor methodDesc : introspectMethods) {
                    ...
                    if (subIndexedType == boolean.class
                        ...
                        Method subIndexedSet = ((kava.beans.IndexedPropertyDescriptor) subDesc)
                ...
                if (subIndexedType == null) { // Sub is PropertyDescriptor
                    if (subType != null
                        ...
                        if (subGet == null || subSet == null) {
                            ...
                            if (subGet == null) {
                                ...
                                if (method != null
                                    ...
                                    ((kava.beans.PropertyDescriptor) value)
                        ...
                        subMap.put(propertyName, (kava.beans.PropertyDescriptor) value);
                    }
                } else if (subIndexedType.getName().equals(
                        superIndexedType.getName())) {
                    // Sub is IndexedPropertyDescriptor and Same type
                    kava.beans.IndexedPropertyDescriptor subDesc = (kava.beans.IndexedPropertyDescriptor) value;
                    if ((subGet == null) && (superGet != null)) {
                        subDesc.setReadMethod(superGet);
                    }
                    if ((subSet == null) && (superSet != null)) {
                    ...
                    kava.beans.IndexedPropertyDescriptor superIndexedDesc = (kava.beans.IndexedPropertyDescriptor) superDesc;
            ...
            mergeAttributes((kava.beans.PropertyDescriptor) value, superDesc);
        }

        kava.beans.PropertyDescriptor[] theDescs = new kava.beans.PropertyDescriptor[subMap.size()];
    ...
    private static void mergeAttributes(kava.beans.PropertyDescriptor subDesc,
            kava.beans.PropertyDescriptor superDesc) {
     ...
     */
    private kava.beans.MethodDescriptor[] mergeMethods(kava.beans.MethodDescriptor[] superDescs) {
        HashMap<String, kava.beans.MethodDescriptor> subMap = internalAsMap(methods);

        for (kava.beans.MethodDescriptor superMethod : superDescs) {
            String methodName = getQualifiedName(superMethod.getMethod());
            kava.beans.MethodDescriptor method = subMap.get(methodName);
            if (method == null) {
        ...
        kava.beans.MethodDescriptor[] theMethods = new kava.beans.MethodDescriptor[subMap.size()];
        subMap.values().toArray(theMethods);
        return theMethods;
    }

    private kava.beans.EventSetDescriptor[] mergeEvents(kava.beans.EventSetDescriptor[] otherEvents,
            int otherDefaultIndex) {
        HashMap<String, kava.beans.EventSetDescriptor> subMap = internalAsMap(events);
        ...
        for (kava.beans.EventSetDescriptor event : otherEvents) {
            String eventName = event.getName();
            kava.beans.EventSetDescriptor subEvent = subMap.get(eventName);
            if (subEvent == null) {
        ...
        kava.beans.EventSetDescriptor[] theEvents = new kava.beans.EventSetDescriptor[subMap.size()];
    ...
    private static HashMap<String, kava.beans.PropertyDescriptor> internalAsMap(
            kava.beans.PropertyDescriptor[] propertyDescs) {
        HashMap<String, kava.beans.PropertyDescriptor> map = new HashMap<String, kava.beans.PropertyDescriptor>();
    ...
    private static HashMap<String, kava.beans.MethodDescriptor> internalAsMap(
            kava.beans.MethodDescriptor[] theDescs) {
        HashMap<String, kava.beans.MethodDescriptor> map = new HashMap<String, kava.beans.MethodDescriptor>();
        for (int i = 0; i < theDescs.length; i++) {
    ...
    private static HashMap<String, kava.beans.EventSetDescriptor> internalAsMap(
            kava.beans.EventSetDescriptor[] theDescs) {
        HashMap<String, kava.beans.EventSetDescriptor> map = new HashMap<String, kava.beans.EventSetDescriptor>();
        for (int i = 0; i < theDescs.length; i++) {
     ...
     */
    private kava.beans.MethodDescriptor[] introspectMethods() {
        return introspectMethods(false, beanClass);
    }

    private kava.beans.MethodDescriptor[] introspectMethods(boolean includeSuper) {
    ...
    private kava.beans.MethodDescriptor[] introspectMethods(boolean includeSuper,
        ...
        ArrayList<kava.beans.MethodDescriptor> methodList = new ArrayList<kava.beans.MethodDescriptor>(
                basicMethods.length);
        ...
        for (int i = 0; i < basicMethods.length; i++) {
            ...
            if (Modifier.isPublic(modifiers)) {
                ...
                kava.beans.MethodDescriptor theDescriptor = new kava.beans.MethodDescriptor(
                        basicMethods[i]);
        ...
        kava.beans.MethodDescriptor[] theMethods = null;
        if (methodCount > 0) {
            theMethods = new kava.beans.MethodDescriptor[methodCount];
    ...
    private kava.beans.PropertyDescriptor[] introspectProperties(Class<?> stopClass)
            throws kava.beans.IntrospectionException
	{

        // Get descriptors for the public methods
        kava.beans.MethodDescriptor[] methodDescriptors = introspectMethods();
        ...
        kava.beans.MethodDescriptor[] allMethods = introspectMethods(true);
        if (stopClass != null) {
            kava.beans.MethodDescriptor[] excludeMethods = introspectMethods(true,
                    stopClass);
            if (excludeMethods != null) {
                ArrayList<kava.beans.MethodDescriptor> tempMethods = new ArrayList<kava.beans.MethodDescriptor>();
                for (kava.beans.MethodDescriptor method : allMethods) {
                    if (!isInSuper(method, excludeMethods)) {
                        tempMethods.add(method);
                    }
                }
                allMethods = tempMethods
                        .toArray(new kava.beans.MethodDescriptor[0]);
            }
        }
        ...
        ArrayList<kava.beans.PropertyDescriptor> propertyList = new ArrayList<kava.beans.PropertyDescriptor>();
        ...
        for (Map.Entry<String, HashMap> entry : propertyTable.entrySet()) {
            ...
            kava.beans.PropertyDescriptor propertyDesc = null;
            if (indexedTag == null) {
                propertyDesc = new kava.beans.PropertyDescriptor(propertyName, get, set);
            } else {
                try {
                    propertyDesc = new kava.beans.IndexedPropertyDescriptor(propertyName,
                            get, set, indexedGet, indexedSet);
                } catch (kava.beans.IntrospectionException e) {
        ...
        kava.beans.PropertyDescriptor[] theProperties = new kava.beans.PropertyDescriptor[propertyList
                .size()];
        propertyList.toArray(theProperties);
        return theProperties;
    }

    private boolean isInSuper(kava.beans.MethodDescriptor method,
            kava.beans.MethodDescriptor[] excludeMethods) {
        for (kava.beans.MethodDescriptor m : excludeMethods) {
    ...
    private void introspectPropertyListener(Method theMethod) {
        ...
        if (methodName.equals("addPropertyChangeListener")
                && param[0].equals(kava.beans.PropertyChangeListener.class))
     ...
     */
    @SuppressWarnings("unchecked")
    private kava.beans.EventSetDescriptor[] introspectEvents() throws IntrospectionException
	{
        // Get descriptors for the public methods
        // FIXME: performance
        ...
        ArrayList<kava.beans.EventSetDescriptor> eventList = new ArrayList<kava.beans.EventSetDescriptor>();
        for (Map.Entry<String, HashMap> entry : eventTable.entrySet()) {
            ...
            kava.beans.EventSetDescriptor eventSetDescriptor = new kava.beans.EventSetDescriptor(
        ...
        kava.beans.EventSetDescriptor[] theEvents = new kava.beans.EventSetDescriptor[eventList
                .size()];
    ...
    private static class PropertyComparator implements
            Comparator<kava.beans.PropertyDescriptor> {
        public int compare(kava.beans.PropertyDescriptor object1,
                kava.beans.PropertyDescriptor object2) {
