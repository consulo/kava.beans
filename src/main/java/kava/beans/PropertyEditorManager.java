...
public class PropertyEditorManager {
    ...
    private static kava.beans.PropertyEditor loadEditor(Class<?> targetType, String className)
        ...
        return (kava.beans.PropertyEditor) editorClass.newInstance();
    }

    public static synchronized kava.beans.PropertyEditor findEditor(Class<?> targetType) {
        if (targetType == null) {
            throw new NullPointerException();
        }
