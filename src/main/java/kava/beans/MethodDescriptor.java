...
public class MethodDescriptor extends FeatureDescriptor
{
    ...
    private kava.beans.ParameterDescriptor[] parameterDescriptors;

    /**
     * <p>
     * Constructs an instance with the given {@link Method} and
     * {@link kava.beans.ParameterDescriptor}s. The {@link #getName()} is set as the name
    ...
    public MethodDescriptor(Method method,
            kava.beans.ParameterDescriptor[] parameterDescriptors) {
        super();
     ...
     * </p>
     * 
     * @return An array of {@link kava.beans.ParameterDescriptor} instance or
     *         <code>null</code>.
     */
